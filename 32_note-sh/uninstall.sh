...
# =============================================================================
# Script de desinstalación para nota (Note Manager)
# =============================================================================
# Elimina el script de gestión de notas de ~/.local/bin/
...
print_header() {
    echo -e "${BLUE}============================================${NC}"
    echo -e "${BLUE}   Desinstalador de nota${NC}"
...
print_uninstall_summary() {
    ...
    echo ""
    print_info "Nota: Las notas creadas con 'nota' no se han eliminado"
    print_info "Puedes eliminarlas manualmente si lo deseas"
    echo ""
}
